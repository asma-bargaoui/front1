...
export class StructureService {
  ...
  getAllStructureWithMinistere():Observable<any[]>{
    return this.http.get<any[]>(endpoint.structureEndpoint+"/with-ministere");
  }
  ...
  deleteStructure({ id }: { id: number; }): Observable<any>{
    return this.http.delete<any>(`${endpoint.structureEndpoint}/delete-child/${id}`)
  }
}
